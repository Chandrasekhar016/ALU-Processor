...
REM
REM Generated by Vivado on Wed Jul 22 22:35:52 +0530 2026
...
echo "xvlog --incr --relax -prj alu_a_tb_vlog.prj"
call xvlog  --incr --relax -prj alu_a_tb_vlog.prj -log xvlog.log
